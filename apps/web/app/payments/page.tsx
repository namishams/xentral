...
export default function PaymentsPage() {
  ...
  return (
    <AppShell active="payments">
      <PageTitleRow title="Payments" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · payments</p>
    </AppShell>
  );
}
