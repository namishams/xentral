...
export default function RelationshipIntelligencePage() {
  ...
  return (
    <AppShell active="relationship-intelligence">
      <PageTitleRow title="Relationship Intelligence" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · relationship-intelligence</p>
    </AppShell>
  );
}
