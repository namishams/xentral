...
export default function SalesPerformancePage() {
  ...
  return (
    <AppShell active="sales-performance">
      <PageTitleRow title="Sales Performance" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · sales-performance</p>
    </AppShell>
  );
}
