...
export default function WorkQueuePage() {
  ...
  return (
    <AppShell active="work-queue">
      <PageTitleRow title="Work Queue" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · work-queue</p>
    </AppShell>
  );
}
