...
export default function CampaignsPage() {
  ...
  return (
    <AppShell active="campaigns">
      <PageTitleRow title="Campaigns" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · campaigns</p>
    </AppShell>
  );
}
