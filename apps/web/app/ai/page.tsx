...
export default function AiPage() {
  ...
  return (
    <AppShell active="ai">
      <PageTitleRow title="Ask Xentral AI" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · ai</p>
    </AppShell>
  );
}
