...
export default function PipelinesPage() {
  ...
  return (
    <AppShell active="pipelines">
      <PageTitleRow title="Pipelines" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · pipelines</p>
    </AppShell>
  );
}
