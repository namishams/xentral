...
export default function ReceivablesPage() {
  ...
  return (
    <AppShell active="receivables">
      <PageTitleRow title="Receivables" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · receivables</p>
    </AppShell>
  );
}
