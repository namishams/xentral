...
export default function ProcurementPage() {
  ...
  return (
    <AppShell active="procurement">
      <PageTitleRow title="Procurement" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · procurement</p>
    </AppShell>
  );
}
