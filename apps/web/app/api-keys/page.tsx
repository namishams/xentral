...
export default function ApiKeysPage() {
  ...
  return (
    <AppShell active="api-keys">
      <PageTitleRow title="API Keys" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · api-keys</p>
    </AppShell>
  );
}
