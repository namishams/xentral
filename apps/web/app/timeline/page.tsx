...
export default function TimelinePage() {
  ...
  return (
    <AppShell active="timeline">
      <PageTitleRow title="Timeline" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · timeline</p>
    </AppShell>
  );
}
