...
export default function RolesPage() {
  ...
  return (
    <AppShell active="roles">
      <PageTitleRow title="Roles" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · roles</p>
    </AppShell>
  );
}
