...
export default function AuditLogsPage() {
  ...
  return (
    <AppShell active="audit-logs">
      <PageTitleRow title="Audit Logs" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · audit-logs</p>
    </AppShell>
  );
}
