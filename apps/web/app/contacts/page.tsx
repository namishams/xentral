...
import { AppShell, PageTitleRow, ExportMenu, ImportButton, Button } from "@xentral/ui";
...
export default async function ContactsPage() {
  ...
  return (
    <AppShell active="contacts">
      <PageTitleRow title="Contacts" subtitle={`${rows.length} people`} actions={<><ExportMenu entity="contacts" /><ImportButton entity="contacts" /><NewCrmButton entity="contact" label="+ New contact" /></>} />
