...
export default function WarehousesPage() {
  ...
  return (
    <AppShell active="warehouses">
      <PageTitleRow title="Warehouses" subtitle={`${ROWS.length} items`} actions={<Button variant="primary">+ New</Button>} />
      <FilterBar>
      ...
      <p style={{ fontSize: 11, color: color.ink.soft, textAlign: "center", marginTop: 14 }}>Scaffolded with `pnpm gen:page` · locked components only · warehouses</p>
    </AppShell>
  );
}
