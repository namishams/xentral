...
export function Button({ children, variant = "secondary", onClick, type = "button", disabled }: {
  ...
  const v: Record<ButtonVariant, React.CSSProperties> = {
    primary: { ...base, background: color.brand.primary, color: "#fff", border: 0 },
    secondary: { ...base, background: "#fff", color: color.ink.DEFAULT, border: `1px solid ${color.line.strong}` },
