...
export function Button({ children, variant = "secondary", onClick, type = "button", disabled }: {
  ...
  const base: React.CSSProperties = { height: uiConstants.control.height, padding: "0 14px", borderRadius: uiConstants.control.radius, fontSize: 13, fontWeight: 600, cursor: disabled ? "default" : "pointer", display: "inline-flex", alignItems: "center", gap: 6, opacity: disabled ? 0.5 : 1 };
